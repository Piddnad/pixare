...
class ProfileForm(forms.Form):
    ...
    name = forms.CharField(label='昵称', max_length=50, required=False)
    city = forms.CharField(label='所在地', max_length=50, required=False)
    intro = forms.CharField(label='个性签名', max_length=100, required=False)
