...
def home(request, user_id):
    ...
    request.pageTitle = people.profile.name + u'的照片'  # django模板使用unicode编码
    return render(request, 'people/home.html', {'people': people, 'p_items': p_items, 'is_myPage': is_myPage})
...
def tags(request, user_id):
    ...
    request.pageTitle = people.profile.name + u"的标签"
    return render(request, 'people/tags.html', {'people': people, 'tag_list': tag_list, 'is_myPage': is_myPage})
...
def profile(request, user_id):
    ...
    request.pageTitle = people.profile.name + u"的个人资料"
    return render(request, 'people/profile.html', {'people': people, 'is_myPage': is_myPage})
...
def likes(request, user_id):
    ...
    request.pageTitle = people.profile.name + u"喜欢的照片"
    return render(request, 'people/likes.html',
                              {'people': people, 'p_items': p_items, 'is_myPage': is_myPage})
...
def follow(request, user_id, is_myFollow=True):
    ...
    request.pageTitle = people.profile.name + u"的关注"
    return render(request, 'people/follow.html', {'is_myPage': is_myPage,'follow_list': follow_list,
...
def comments(request, user_id, is_myComments=False):
    ...
    request.pageTitle = request.user.profile.name + u"的评论"
    return render(request, 'people/comments.html', {'is_myPage': True,
